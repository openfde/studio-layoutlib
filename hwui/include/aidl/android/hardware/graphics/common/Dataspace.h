...
template <>
constexpr inline std::array<aidl::android::hardware::graphics::common::Dataspace, 63> enum_values<aidl::android::hardware::graphics::common::Dataspace> = {
