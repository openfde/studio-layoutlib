...
template <>
constexpr inline std::array<aidl::android::hardware::graphics::common::PixelFormat, 33> enum_values<aidl::android::hardware::graphics::common::PixelFormat> = {
