...
namespace android {
namespace os {
::android::status_t ServiceDebugInfo::readFromParcel(const ::android::Parcel* _aidl_parcel) {
...
::android::status_t ServiceDebugInfo::writeToParcel(::android::Parcel* _aidl_parcel) const {
  ::android::status_t _aidl_ret_status = ::android::OK;
  size_t _aidl_start_pos = _aidl_parcel->dataPosition();
